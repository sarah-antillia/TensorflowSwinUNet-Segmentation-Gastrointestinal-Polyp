...
# 2023/06/22 Antillia.com Toshiyuki Arai
# 
...
def create_master(images_dir, masks_dir, output_dir):
...
if __name__ == "__main__":
  try:
    images_dir = "./images"
    masks_dir  = "./masks"
    output_dir = "./GastrointestinalPolyp"
    ...
    # create_master_256x256 dataset train, test
    # from the orignal SEG .
    create_master(images_dir, masks_dir, output_dir)
